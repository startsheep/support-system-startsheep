                                    ...
                                    <td class="content-cell"
                                        ...
                                        @foreach ($data as $ticket)
                                            ...
                                            <p
                                                ...
                                                {{ $ticket->ticket_code }} - {{ $ticket->ticket_title }}
                                                                    ...
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                                <form
                                                                                    action="{{ url('ticket/' . $ticket->id . '/detail') }}"
                                                                                    target="_blank" method="POST">
                                                                                    <a href="{{ url('ticket/' . $ticket->id . '/detail') }}"
                                                                                        class="button button-primary"
                                                                                        rel="noopener"
                                                                                        style="cursor: pointer; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #2d3748; border-bottom: 8px solid #2d3748; border-left: 18px solid #2d3748; border-right: 18px solid #2d3748; border-top: 8px solid #2d3748;">View
                                                                                        Ticket</a>
                                                                                </form>
                                                                            </td>
                                                                        </tr>
                                        ...
                                        <p
                                            ...
                                            This is an automatic email, please do not reply this message! <br>
                                            <br>
                                            Thank you,<br>
                                            <strong>Startsheep Support System</strong>.
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} Startsheep Support System. All rights reserved.</p>
